...
// Page configuration for Phase 3 components
$pageTitle = 'Edit: ' . $website['site_name'];
$currentPage = 'website-edit';
$extraCss = ['css/website-edit.css'];
...
<div class="cms-content">
    ...
    <form method="POST" enctype="multipart/form-data" class="cms-form" id="websiteEditForm">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <small>PNG, JPG, WEBP • <strong>Minimum: 512x512px</strong><br>Auto-generates all sizes</small>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <small>Language shown when user visits without prefix</small>
                </div>
        ...
        <div class="form-section">
            ...
            <div class="enabled-languages-info">
                ...
                <span class="info-text">
                    Select which languages are available for this website. Disabled language URLs will return 404 for better SEO.
                </span>
            </div>
            ...
            <small style="display: block; margin-top: 15px; color: #7f8c8d;">
                <strong>Note:</strong> English (master) and default language cannot be disabled.
            </small>
        </div>
        ...
        <div class="form-section custom-code-section">
            ...
            <p class="section-description">Add code to &lt;head&gt; section (AdSense, tracking pixels, meta tags)</p>
            
            <div class="form-group">
                <label for="custom_head_code">Custom &lt;head&gt; Code</label>
                <textarea id="custom_head_code" name="custom_head_code" rows="10" 
                          placeholder="<!-- Paste your AdSense, tracking pixels here -->"><?php echo htmlspecialchars($website['custom_head_code'] ?? ''); ?></textarea>
                <small class="warning-text">⚠️ Invalid code can break your website. Test after saving.</small>
            </div>
        </div>
