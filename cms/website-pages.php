 ...
 * ALL FEATURES PRESERVED: Language tabs, drag-drop, modals, icons
 */
...
$pageTitle = 'Manage Pages: ' . $website['site_name'];
$currentPage = 'website-pages';
$extraCss = ['css/website-pages.css'];
$extraJs = ['js/website-pages.js'];
$bodyData = ['preview-domain' => $previewDomain];
...
<div class="cms-content">
    ...
    <div class="content-section sports-section">
        ...
        <div class="pages-accordion" id="sportsAccordion">
            ...
            ?>
                <details class="sport-card" data-sport-name="<?php echo htmlspecialchars($sport); ?>">
                    <summary>
...
<div class="modal" id="renameModal">
    <div class="modal-content modal-small">
        <h3>Rename Sport</h3>
        <p>Enter new name for: <strong id="currentNameDisplay"></strong></p>
        <form method="POST" id="renameForm">
            <input type="hidden" name="rename_sport" value="1">
            <input type="hidden" name="old_sport_name" id="oldSportName">
            <div class="form-group">
                <input type="text" name="new_sport_name" id="newSportNameInput" placeholder="New sport name" required>
            </div>
...
<div class="modal" id="deleteModal">
    <div class="modal-content modal-small">
        ...
        <h3>Delete Sport</h3>
        <p>Are you sure you want to delete <strong id="deleteSportNameDisplay"></strong>?</p>
        ...
        <form method="POST" id="deleteForm">
            ...
            <input type="hidden" name="sport_to_delete" id="deleteSportName">
            <div class="form-group">
...
<div class="modal" id="saveOrderModal">
    <div class="modal-content modal-small">
        ...
        <p>You've reordered the sports. Do you want to save this new order?</p>
        <div class="modal-buttons">
            <button type="button" class="btn btn-outline" onclick="cancelOrderChange()">Cancel</button>
            <button type="button" class="btn btn-primary" onclick="confirmSaveOrder()">Save Order</button>
        </div>
    </div>
</div>
